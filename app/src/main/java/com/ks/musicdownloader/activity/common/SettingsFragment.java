...
public class SettingsFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_OK) {
            LogUtils.d(TAG, "Result is not RESULT_OK");
            return;
        }
        if (requestCode == Constants.SET_DEFAULT_FOLDER_REQUEST_CODE) {
            ...
            LogUtils.d(TAG, "onActivityResult(): destinationFolderPreference, data: " +
    ...
    private void initDefaultFolderPreference() {
        LogUtils.d(TAG, "initDefaultFolderPreference: ");
    ...
    private void displayExplorer() {
        ...
        LogUtils.d(TAG, "displayExplorer: ");
...
//        intent.setDataAndType(selectedUri, "resource/folder");
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.d(TAG, "Error in starting activity for selecting folder. Error: " + e);
